...
public class GlobalWarmingPlugin extends JavaPlugin implements SlimefunAddon {
    ...
    private void registerItems() {
        ItemGroup itemGroup = new ItemGroup(new NamespacedKey(this, "global_warming"), new CustomItemStack(Items.THERMOMETER, "&2全球暖化"));
        ...
        new TemperatureMeter(itemGroup, Items.AIR_QUALITY_METER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
            ...
            public void tick(Block b) {
                Location loc = b.getLocation();
                updateHologram(b, "&7氣候變化: " + GlobalWarmingPlugin.getTemperatureManager().getAirQualityString(loc.getWorld(), TemperatureType.valueOf(BlockStorage.getLocationInfo(loc, "type"))));
            }
        }.register(this);
    ...
    public String getBugTrackerURL() {
        return "https://github.com/SlimeTraditionalTranslation/GlobalWarming/issues";
    }
