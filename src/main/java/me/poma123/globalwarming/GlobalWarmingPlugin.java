...
public class GlobalWarmingPlugin extends JavaPlugin implements SlimefunAddon {
    ...
    private void registerItems() {
        ...
        new TemperatureMeter(category, Items.AIR_QUALITY_METER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
            ...
            public void tick(Block b) {
                Location loc = b.getLocation();
                SimpleHologram.update(b, "&7氣候變化: " + GlobalWarmingPlugin.getTemperatureManager().getAirQualityString(loc.getWorld(), TemperatureType.valueOf(BlockStorage.getLocationInfo(loc, "type"))));
            }
        }.register(this);
